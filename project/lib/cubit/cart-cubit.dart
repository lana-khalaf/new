...
async {
 emit(CartLoadingState());
   try{
    ...
    //  query: بدي اخد ال id  من الباك
      ...
      emit(CartErrortState('HTML error response'));
      print('dfjka');
    } else {
    ...
    emit(CartErrortState(error.toString()));
 ...
 Future< void> AddDetailsOrderCart ({
